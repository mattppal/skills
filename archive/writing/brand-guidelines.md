...
<introduction>
These are the Replit brand guidelines as of EOY 2024, enhanced with Matt Palmer's northstar principles for consistent, effective communication.

This document informs the style and tone of our user-facing communications, including casing, punctuation, and social posts. It integrates with Matt Palmer's personal brand framework and XML prompting structure for optimal content creation.
</introduction>

<integration_note>
For Matt Palmer-specific content creation, reference:
- [`/Users/matt/Developer/prompts/northstar/personal-brand.md`] for voice characteristics and content pillars
- [`/Users/matt/Developer/prompts/northstar/prompt-structure.md`] for XML structuring techniques
- [`/Users/matt/Developer/prompts/northstar/grammar.md`] for voice mode applications
</integration_note> 
...
- Checking your copy against these guidelines
    ...
    Just click the lil’ “Clippy” looking notion guy and change the context to “In this page,” then ask for copy edits.
...
- **Replit in 40 characters**
    ...
    Idea to app, fast.
    To simplify complex information, follow these steps:
1. Identify the core concept or main idea.
2. Break down the concept into its basic components or key points.
3. Explain each component in simple terms, avoiding jargon or technical language unless necessary.
4. Use analogies or examples to illustrate complex ideas and make them more relatable.
5. Organize the information in a logical and easy-to-follow structure.
By applying these steps, you can make complex information more understandable and accessible to your audience. 
...
- **Replit in 400 characters**
    ...
    Replit turns your ideas into apps, fast. With Replit's Agent and Assistant, create apps from natural language and launch them in a single click. Build and deploy full-stack apps directly from your browser—no setup or install required. Whether you're a non-technical beginner or a pro, Replit bridges the gap, empowering everyone to create, collaborate, and bring ideas to life effortlessly.
...
**AI-Powered**: Replit’s two AI tools, Agent & Assistant, take users from zero to MVP and beyond. Agent can stand up a full-stack application, complete with databases and services. Assistant makes targeted edits and adds features. Go from zero to app with just natural language.
...
From prompt to app, Agent is our flagship product. It’s our fully automated developer in the cloud. It can build entire projects from scatch—configuring your development environment, installing all the languages and packages, adding databases, even running the app. All you have to do is describe what you’re after and Agent gets to work. Once you have an MVP, you can use Agent to continue to iterate and add features. Agent supports mentioning files, attaching images, and scraping / screenshotting websites.
...
Replit Apps are personal software that runs on Replit.—built by Agent or with Assistant, deployed on Replit, or powered by Replit Cloud Services. Replit Apps are simple and opinionated, by default. They’re accessible to anyone, even non-technical users and are the fastest way to go from idea to app.

Simplicity: Deploy straight from the editor. Replit is the fastest way to go from idea to production.

Reliability: Replit’s hosting has high uptime and auto scalability. Go from prototype to full-scale web app all on Replit, and pay only for the resources you use.
...
Object storage: if you’re new to data, think about object storage like a file directory in the cloud. You can drag and drop files, then access them in your apps. If you’ve built with object storage, we’re backed by GCP and support all Google’s client libraries, as well as our own, simplified SDKs. Use object storage without leaving your browser.
...
- **Create genuine value**
    ...
    - *Example: “Here’s how you can store your sensitive data, like API keys and tokens, safely and securely on Replit.”*
- **Geek out**
    - Create content that shows you’re looking at things from their perspective
    - *Example: “But how can we be sure Replit is truly built for developing robust startups? We know because we used Expandable Storage to run our codebase at Replit.”*
- **Use plain language and recognized terminology**
    - If there’s a technical term that is accurate, use it, and link to relevant documentation when appropriate
    - *Example: “All Repls use [btrfs](https://en.wikipedia.org/wiki/Btrfs) as their filesystem.”*
- **Only make claims that can be substantiated**
    - Be factual about the product in your messaging
    - *Example: “Since its initial launch, the scanned secrets warning has prevented more than 500 API keys and secrets from ending up in open source code.”*
- **Provide context for what Replit is and what it can do**
    - *Example: “We have built deployments to be an all-in-one product. Building and deploying in the same place makes for a seamless experience. We continue to add and adjust features to make sure you can do it all within Replit.”*
- **Focus on the desired outcomes, not just the activities**
    - *Example: “We’re continuing to improve Ghostwriter's inline actions: Explain Code, Generate Code, and Edit Code. These updates are all about making your coding sessions smoother and more productive.”*
...
- **Use "you" in marketing communications**
    - *Example: “Build and deploy your own AI transcription app in 3 minutes on Replit.”*

**Don’t:**

- Be hyperbolic
    - *Example: “The world’s best IDE that everyone loves”*
- Use fluff or gimmicky hooks
    - *Example: “Want to make a million dollars in a year? Deploy an app on Replit”*
- Use language that implies we are an EDU tool
    - *Example: learn, teach*
- Use more than one emoji in any type of communication – only use sparingly
    - Example: 😅😝👇
...
We use emdashes (—) over hyphens (-) except for hyphenated words. Emdashes should not be surrounded by spaces. 

*Example: Our great-grandmother is a remarkable woman—she’s overcame much in her life.*
...
- Do not use Hashtags
- Use threads to circumvent X’s algorithm while still conveying meaningful, long-form content.
...
- Do: number threads for numeric content. E.g. “Here are our 5 new releases today: 1/ , 2/ , etc”
